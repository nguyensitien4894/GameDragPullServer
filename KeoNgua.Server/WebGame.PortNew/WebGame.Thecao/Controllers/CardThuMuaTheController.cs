...
namespace MsWebGame.Thecao.Controllers
{
    ...
    public class CardThuMuaTheController : BaseApiController
    {
        ...
        //            CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "error", -1, PARTNER_FIVE, out outResponse);
        //            if (outResponse == 1)
        //            {
        ...
        //            CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "success", 1, PARTNER_FIVE, out outResponse);
        //            if (outResponse == 1)
        //            {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "success", 3, PARTNER_FIVE, out outResponse);
        //                    if (outResponse == 1)
        //                    {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "success", 2, PARTNER_FIVE, out outResponse);
