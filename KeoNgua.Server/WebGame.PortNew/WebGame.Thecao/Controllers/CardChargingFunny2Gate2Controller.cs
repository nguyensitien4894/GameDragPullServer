...
{
    [RoutePrefix("api/CardChargingFunny2Gate2")]
    public class CardChargingFunny2Gate2Controller : BaseApiController
    {
        private int PARTNER_SIX = 6;
        ...
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, STATUS_SMG_NOT_REFUND, PARTNER_SIX, value, minValue, receiveValue, out outResponse);
        //                if (outResponse == 1)
        //                {
        //                    try
        //                    {
        ...
        //            {
        //                SendChargingHub(card.UserID, 0, "Nạp thẻ thất bại", 0, ServiceID);
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, -1, PARTNER_SIX, value, null, null, out outResponse);
        //                if (outResponse == 1)
        //                {
        ...
        //            CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode.ToString(), message, 1, PARTNER_SIX, value, null, null, out outResponse);
        //            if (outResponse == 1)
        //            {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, errorCode, message, 3, PARTNER_SIX, out outResponse);
        //                    if (outResponse == 1)
        //                    {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, errorCode, message, 2, PARTNER_SIX, out outResponse);
