...
namespace MsWebGame.Thecao.Controllers
{
    ...
    public class CardFcconnClubController : BaseApiController
    {
        ...
        //        }
        //        NLogManager.LogMessage("P3 uri"+Request.RequestUri.ToString());
        //        NLogManager.LogMessage("P3data" + JsonConvert.SerializeObject(request));
        ...
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(card.RequestID, card.UserID, request.error_code.ToString(), request.error_desc + "Sai mệnh giá", STATUS_SMG_NOT_REFUND, PARTNER_THREE, value, minValue, receiveValue, out outResponse);
        ...
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(card.RequestID, card.UserID, request.error_code.ToString(), request.error_desc, -1, PARTNER_THREE, request.value, null, null, out outResponse);
        //                SendChargingHub(card.UserID, 0, "Nạp thẻ thất bại", 0, ServiceID);
        //                if (outResponse == 1)
        //                {
        ...
        //                    outResponse = 0;
        //                    CardRefDAO.Instance.UpdateCardChardRefStatus(card.RequestID, card.UserID, request.error_code.ToString(), request.error_desc, 3, PARTNER_THREE, request.value,null,null, out outResponse);
        //                    if (outResponse == 1)
        //                    {
        ...
        //                    outResponse = 0;
        //                    CardRefDAO.Instance.UpdateCardChardRefStatus(card.RequestID, card.UserID, request.error_code.ToString(), request.error_desc, 2, PARTNER_THREE, request.value,null,null, out outResponse);
