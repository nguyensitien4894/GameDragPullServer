...
{
    [RoutePrefix("api/CardThuMuaTheGate2")]
    public class CardThuMuaTheGate2Controller : BaseApiController
    {
        //private int PARTNER_ELEVEN = 11;
        ...
        //            CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "error", -1, PARTNER_ELEVEN, out outResponse);
        //            if (outResponse == 1)
        //            {
        ...
        //            CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "success", 1, PARTNER_ELEVEN, out outResponse);
        //            if (outResponse == 1)
        //            {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "success", 3, PARTNER_ELEVEN, out outResponse);
        //                    if (outResponse == 1)
        //                    {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, status.ToString(), "success", 2, PARTNER_ELEVEN, out outResponse);
