...
{
    [RoutePrefix("api/CardChargingFunny3Gate3")]
    public class CardChargingFunny3Gate3Controller : BaseApiController
    {
        private int PARTNER_EIGHT = 8;
        ...
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, STATUS_SMG_NOT_REFUND, PARTNER_EIGHT, value, minValue, receiveValue, out outResponse);
        //                if (outResponse == 1)
        //                {
        //                    try
        //                    {
        ...
        //                    var msg = String.Format("{0}|{1}", "00", String.Format("H1{0}", ErrorMsg.CardUpdateStatus_Negative3));// trạng thái thẻ khác 00 và khác 1   cập nhật ngay về trang
        //                    return StringResult(msg);
        ...
        //            {
        //                SendChargingHub(card.UserID, 0, "Nạp thẻ thất bại", 0, ServiceID);
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, -1, PARTNER_EIGHT, value, null, null, out outResponse);
        //                if (outResponse == 1)
        //                {
        ...
        //            CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode.ToString(), message, 1, PARTNER_EIGHT, value, null, null, out outResponse);
        //            if (outResponse == 1)
        //            {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, errorCode, message, 3, PARTNER_EIGHT, out outResponse);
        //                    if (outResponse == 1)
        //                    {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, errorCode, message, 2, PARTNER_EIGHT, out outResponse);
