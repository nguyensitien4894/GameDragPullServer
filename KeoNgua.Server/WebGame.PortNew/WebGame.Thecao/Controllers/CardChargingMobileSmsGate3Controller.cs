...
{
    [RoutePrefix("api/CardChargingMobileSmsGate3")]
    public class CardChargingMobileSmsGate3Controller : BaseApiController
    {

        // private int PARTNER_NINE = 9;
        ...
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, STATUS_SMG_NOT_REFUND, PARTNER_NINE, value, minValue, receiveValue, out outResponse);
        //                if (outResponse == 1)
        //                {
        //                    try
        //                    {
        ...
        //            else
        //            {
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, data.errorid.ToString(), data.errordesc, -1, PARTNER_NINE, data.amount, null, null, out outResponse);
        //                SendChargingHub(card.UserID, 0, "Nạp thẻ thất bại", 0, ServiceID);
        //                if (outResponse == 1)
        //                {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, data.errorid.ToString(), data.errordesc, 3, PARTNER_NINE, out outResponse);
        //                    if (outResponse == 1)
        //                    {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, data.errorid.ToString(), data.errordesc, 2, PARTNER_NINE, out outResponse);
