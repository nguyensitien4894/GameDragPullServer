...
namespace MsWebGame.Thecao.Helpers
{
    public class CaptchaImage
    {
        ...
        public CaptchaImage()
        {
            ...
            _backgroundNoise = BackgroundNoiseLevel.Extreme;
            _lineNoise = LineNoiseLevel.Medium;
            _width = 180;
            _height = 50;
            _randomTextLength = 3;
        ...
        private PointF RandomPoint(Rectangle rect)
        {
            int top = rect.Top;
            int bot = rect.Bottom;
            return RandomPoint(rect.Left, rect.Width, ref top, ref bot);
        }
        ...
        private void WarpText(GraphicsPath textPath, Rectangle rect)
        {
            ...
            int _top = top + hrange;
            int _height = height - hrange;

            PointF leftTop = RandomPoint(left, left + wrange, ref top, ref _top);
            PointF rightTop = RandomPoint(width - wrange, width, ref top, ref _top);
            PointF leftBottom = RandomPoint(left, left + wrange, ref _height, ref height);
            PointF rightBottom = RandomPoint(width - wrange, width, ref _height, ref height);
