...
namespace MsWebGame.Thecao.Database.DAO
{
    public class CardDAO
    {
        ...
        public void UserCardRechargeCreate(int TelOperatorID, int CardID, int CardValue, int Status, double Rate, long UserID, long ReceivedMoney, long CreateUser, string CardNumber, string SerialNumber, string PartnerErrorCode, string PartnerMessage, string Description, string Signature, out int Response, out long RequestID)
        {
            DBHelper db = null;
            try
            {
        ...
        /// <returns></returns>
        public List<UserCardRecharge> UserCardRechargeList(long RequestID,long UserID, int TelOperatorID, int CardID, int CardValue, string UserName, string CardNumber, string SerialNumber, DateTime? FromRechargeDate, DateTime? ToRechargeDate, int CurrentPage, int RecordPerpage, out int TotalRecord)
        {
        ...
        /// <param name="Response"></param>
        /// <param name="RemainBalance"></param>
        public void UserCardCashout(long AccountId,int Amount, string TelCode, int DeviceType, out int Status, out int Response,  out long RemainBalance )
        {
            DBHelper db = null;
            try
            {
        ...
        public void UserCardSerialCount( long AccountID, string SerialNumber,int TelOperatorID, out int Response)
        {
            DBHelper db = null;
            try
            {
