...
namespace MsWebGame.Thecao.Database.DAO
{
    public class USDTDAO
    {
        ...
        /// <param name="RemainBalance"></param>
        /// <param name="PartnerStatus"></param>
        public void UserBankRequestPartnerCheckMopay(string ChargeCode, long UserID, int CheckStatus, int ServiceID, double? RealUSDTAmount, double RequestRate, long CheckerID, long RequestAmount, long? RealAmount, long? RealReceivedMoney, string PartnerStatus, out long RemainBalance, out int Response)
        {
            DBHelper db = null;
            try
            {
                ...
                param[0] = new SqlParameter("@_CheckerID", SqlDbType.BigInt);
                param[0].Value = CheckerID;
                param[1] = new SqlParameter("@_ChargeCode", SqlDbType.VarChar);
                param[1].Value = ChargeCode;
                param[2] = new SqlParameter("@_UserID", SqlDbType.BigInt);
                param[2].Value = UserID;
                param[3] = new SqlParameter("@_CheckStatus", SqlDbType.Int);
                param[3].Value = CheckStatus;
                ...
                param[12] = new SqlParameter("@_Response", SqlDbType.Int);
                param[12].Direction = ParameterDirection.Output;
                db.ExecuteNonQuerySP("SP_UserBankRequest_PartnerCheckMopay", param.ToArray());
                Response = ConvertUtil.ToInt(param[12].Value);
        ...
        public UserBankRequest UserBankRequestGetByCodeFromPartner(int PartnerID, string RequestCode
           ...
           )
        {
            ...
            try
            {
                ...
                param[0] = new SqlParameter("@_PartnerID", SqlDbType.Int);
                param[0].Value = PartnerID ;
                param[1] = new SqlParameter("@_RequestCode", SqlDbType.VarChar);
                param[1].Size = 50;
                param[1].Value = RequestCode;

                var _lstUserBankRequest = db.GetInstanceSP<UserBankRequest>("SP_UserBankRequest_GetByCodeFromPartner", param.ToArray());
