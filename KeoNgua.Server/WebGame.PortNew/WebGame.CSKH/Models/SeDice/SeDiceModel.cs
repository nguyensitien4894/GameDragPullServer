...
namespace MsWebGame.CSKH.Models.SeDice
{
    ...
    public class SeDiceRaceTopModel
    {
    ...
    public class SeDiceReportEventModel
    {
        public int? EventID { get; set; }
    ...
    public class SeDiceSessionDice
    {
        public long SessionId { get; set; }
        public long BetTotalChan { get; set; }
        public long BetTotalLe { get; set; }
        public long UserTotalChan { get; set; }
        public long UserTotalLe { get; set; }
    }
    public class SeDiceUserBetModel
    {
    ...
    public class SeDiceUserBetBalance
    {
        public long AccountID { get; set; }
        public long SessionID { get; set; }
        public long Amount { get; set; }
