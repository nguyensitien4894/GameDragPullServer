...
{
    public class LuckyDiceDAO
    {
        private static readonly Lazy<LuckyDiceDAO> _instance = new Lazy<LuckyDiceDAO>(() => new LuckyDiceDAO());

        public static LuckyDiceDAO Instance
        {
