...
namespace MsWebGame.Portal.Handlers
{
    public class ConnectionHandler
    {
        ...
        public void SendMessageToClient(string coonnectionId, string message)
        {
            HubContext.Clients.Client(coonnectionId).message(message);
        }

        public void SendMessageToClient(string coonnectionId, object message)
        {
            HubContext.Clients.Client(coonnectionId).message(message);
        }
