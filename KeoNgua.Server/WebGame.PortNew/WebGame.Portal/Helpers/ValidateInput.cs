...
namespace MsWebGame.Portal.Helpers
{
    public class ValidateInput
    {
        public static bool ValidatePhoneNumber(string phoneNumber)
        {
            ...
            //if (!phoneNumber.StartsWith("0")&& !phoneNumber.StartsWith("1")) return false;
            //if (phoneNumber.StartsWith("00")) return false;
            if (phoneNumber.Length < 9) return false;
            phoneNumber = phoneNumber.Replace(".", "").Trim();
            phoneNumber = phoneNumber.Replace("+", "").Trim();

            //var IsPhone = new Regex(@"(09|07|05|03[2|3|4|5|6|7|8|9]|07[0|9|7|6|8]|08[3|4|5|1|2|6|8|7|8|9])+([0-9]){7,}\b");
        ...
        public static bool ValidateStringAnpha(string str)
        {
