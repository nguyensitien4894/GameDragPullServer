namespace MsWebGame.Portal.Controllers
{
    ...
    //            {
    //                var msg = String.Format("{0}|{1}", "01", ErrorMsg.ParamaterInvalid);
    //                NLogManager.LogMessage("ERR-2");
    //                return StringResult(msg);
    //            }
    //            if (lngGameAccountID <= 0)
    //            {
    //                var msg = String.Format("{0}|{1}", "01", ErrorMsg.ParamaterInvalid);
    //                NLogManager.LogMessage("ERR-3");
    //                return StringResult(msg);
    //            }
    ...
    //                return StringResult(msg);
    //            }
    //            //if (card.OperatorCode != "VTT")//báo lỗi vì lại thẻ không chính xác thẻ viettel
    //            //{
    ...
    //              //  CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, errorCode, message, -1, PARTNER_FOUR, out outResponse);
    //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, -1, PARTNER_FOUR, value, out outResponse);
    //                if (outResponse == 1)
    //                {
    ...
    //               // CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, errorCode, message, 1, PARTNER_FOUR, out outResponse);
    //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode.ToString(), message, 1, PARTNER_FOUR, value, out outResponse);
    //                if (outResponse == 1)
    //                {
