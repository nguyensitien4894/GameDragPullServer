...
namespace MsWebGame.Portal.Database.DAO
{
    public class UserTranferDAO
    {
        ...
        public void UserTransferToUser( long RemitterId, long ReceiverId, long Amount, string Note,int ServiceID, out long TransID, out long RemainWallet, out int Response)
        {
            DBHelper db = null;
            try
            {
        ...
        public void UserTransferToAgencyAdmin(long RemitterId, long ReceiverId,string ReceiverName,int ReceiverType, int ReceiverLevel, long Amount, string Note, int ServiceID,out long TransID, out long RemainWallet, out int Response,out long walletRemain)
        {
            DBHelper db = null;
            try
            {
                ...
                param[11] = new SqlParameter("@_ReceiverWallet", SqlDbType.BigInt);
                ...
                if (Response == 1)
                {
                    walletRemain = Convert.ToInt64(param[11].Value);
        ...
        /// <returns></returns>
        public List<BalanceLogs> BalanceLogsList(long UserID, string UserName, int TranType, DateTime? FromDate, DateTime? ToDate,int ServiceID, int CurrentPage, int RecordPerpage, out int TotalRecord)
        {
            DBHelper db = null;
            try
            {
                ...
                //new
                var _lstBalanceLogs = db.GetListSP<BalanceLogs>("SP_BalanceLogs_List_New", param.ToArray());
        ...
        public void UserTransferToBot( long RemitterID, long BotID, long Amount, int ServiceID, string Note, out long TransID, out long RemainWallet, out int Response)
        {
            DBHelper db = null;
            try
            {
                ...
                param[0] = new SqlParameter("@_RemitterID", SqlDbType.BigInt);
                param[0].Value = RemitterID;
                param[1] = new SqlParameter("@_BotID", SqlDbType.BigInt);
                param[1].Value = BotID;
                param[2] = new SqlParameter("@_Amount", SqlDbType.BigInt);
                param[2].Value = Amount;
                param[3] = new SqlParameter("@_Note", SqlDbType.NVarChar);
                ...
                db.ExecuteNonQuerySP("SP_User_Transfer_To_Bot", param.ToArray());
                Response = Convert.ToInt32(param[7].Value);
                if (Response == 1)
                {
                    TransID = Convert.ToInt64(param[5].Value);
        ...
        public void AccountCheckBank(string banknumber, out int Response)
        {
            DBHelper db = null;
            try
            {
                ...
                param[0] = new SqlParameter("@_UserID", SqlDbType.NVarChar);
                param[0].Size = 50;
                param[0].Value = banknumber;
                param[1] = new SqlParameter("@_Response", SqlDbType.Int);
                param[1].Direction = ParameterDirection.Output;
                db.ExecuteNonQuerySP("SP_AccountHack_By_AccountBankNumber", param.ToArray());
                Response = Convert.ToInt32(param[1].Value);
                return;
            }
            catch (Exception ex)
