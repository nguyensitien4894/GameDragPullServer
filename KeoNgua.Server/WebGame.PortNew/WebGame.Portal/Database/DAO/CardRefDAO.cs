...
namespace MsWebGame.Portal.Database.DAO
{
    public class CardRefDAO
    {
        ...
        public List<UserCardRecharge> UserCardRechargeByRefKey2(string RefKey, int PartnerID)
        {
        ...
        public void UpdateCardChardRefStatus2(long ReqestID, long UserID, string FeedbackErrorCode, string FeedbackMessage, int Status, int PartnerID, int ValidAmount, long? RefundCardValude, long? RefundReceivedMoney, out int Response)
        {
            DBHelper db = null;
            try
            {
        ...
        public void UpdateCardChardRefStatus(long ReqestID, long UserID, string FeedbackErrorCode, string FeedbackMessage, int Status, int PartnerID, int ValidAmount, out int Response)
        {
            DBHelper db = null;
            try
            {
