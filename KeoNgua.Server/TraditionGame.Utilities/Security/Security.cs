...
namespace TraditionGame.Utilities.Security
{
    public class Security
    {
        ...
        public static string MessageEncrypt(string data)
        {
            try
            {
                ...
                string str = new RijndaelEnhanced("redblack@1", "@1B2c3D4e5F6g7H8").Encrypt(data);
                return str;
            }
            catch
            {
        ...
        public static string MessageDecrypt(string data)
        {
            try
            {
                if (string.IsNullOrEmpty(data))
                ...
                string str = new RijndaelEnhanced("redblack@1", "@1B2c3D4e5F6g7H8").Decrypt(data);
                return str;
            }
            catch
            {
