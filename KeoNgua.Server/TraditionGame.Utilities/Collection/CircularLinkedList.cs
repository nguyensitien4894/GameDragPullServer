...
namespace TraditionGame.Utilities.Collection
{
    ...
    public sealed class CircularLinkedList<T> : ICollection<T>, IEnumerable<T>
    {
        ...
        public CircularLinkedList(IEnumerable<T> collection) : this(collection, EqualityComparer<T>.Default)
        {
        }
        ...
        public CircularLinkedList(IEqualityComparer<T> comparer) : this(null, comparer)
        {
        }
