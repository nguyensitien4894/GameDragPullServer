...
[assembly: OwinStartup(typeof(KeoNgua.Server.App_Start.Startup))]
namespace KeoNgua.Server.App_Start
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            var initBot = BotHandler.Instance;
            var init = KeoNguaHandler.Instance;
        }
